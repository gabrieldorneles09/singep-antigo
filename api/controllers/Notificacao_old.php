...
namespace controllers {
    ...
    class Notificacao {
        ...
        public function setEnviar() {
            ...
            $sql = "INSERT INTO notificacao (texto, tipo) "
                    . "VALUES (:texto, :tipo)";
            ...
            $this->PDO = NULL;
            unset($this->PDO);
            $app->render('default.php', ["data" => json_decode('{"retorno": "Notificação inserida com sucesso"}')], 200);
        }
        ...
        public function getAll() {
            ...
            $sql = "SELECT "
                    . "notificacao.codigo_notificacao, notificacao.texto, "
        ...
        public function getNovas() {
            ...
            # Recupera as notificações do participante
            $sql = "SELECT "
                    . "notificacoes.id_notificacao AS codigo_notificacao, notificacao.texto, "
                    . "date_format(notificacoes.data_envio, '%d/%m/%Y') AS data_envio, "
                    . "date_format(notificacoes.data_leitura, '%d/%m/%Y') AS data_leitura "
                    . "FROM notificacao "
                    . "INNER JOIN notificacoes "
